...
function updatePsd(){
	...
	var $body=$("<div>").addClass("modal-body");	
		...
		$body.append("<input class='input-large span4' id='old_password'  type='password' placeholder='请输入原密码' maxlength='50' ><br/>");
		$body.append("<span class='add-on' style='width:80px'><i class='halflings-icon user'></i> 新密码 </span>");		
		$body.append("<input class='input-large span4' id='new_password'  type='password' placeholder='请输入新密码' maxlength='50' ><br/>");		
		$body.append("<span class='add-on' style='width:80px'><i class='halflings-icon user'></i> 重&nbsp;复 </span>");		
		$body.append("<input class='input-large span4' id='repeat_password'  type='password' placeholder='请再次输入新密码' maxlength='50' ><br/>");		

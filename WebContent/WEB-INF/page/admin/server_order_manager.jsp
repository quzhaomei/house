		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					...
					<form action="getOrder.html" method="post" id="myform" rel="admin-form">
						...
						<input name="requiredId" type="hidden" value="${requiredId}"/>
						<table class="table">
						<tr>
	...
	$(function(){
		...
		$(".getOrder").on("click",function(){
			...
			layer.confirm("确定接单吗？", {
				...
				param.operator="check";
				//先检测余额
				$.post("getOrder.html",param,function(json){
					if(json.status==1){
						window.location.href="getOrder.html?orderId="+orderId;
					}else{
